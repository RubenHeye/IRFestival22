        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, 1, "marvingaye.jpg", "Lucky luckyyyy", "http://www.marvingayepage.net/" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A music festival is a festival oriented towards music that is sometimes presented with a theme such as musical", 1, "Main Stage" },
                    { 2, "A music festival is a festival oriented towards music that is sometimes presented with a theme such as musical", 1, "Orange Room" },
                    { 3, "A music festival is a festival oriented towards music that is sometimes presented with a theme such as musical", 1, "StarDust" },
                    { 4, "A music festival is a festival oriented towards music that is sometimes presented with a theme such as musical", 1, "Blue Room" }
                });
